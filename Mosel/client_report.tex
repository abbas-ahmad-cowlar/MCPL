...
Recent advances in mathematical programming and Benders decomposition techniques have enabled exact solution of MCLP instances with millions of demand points \cite{cordeau2019}. However, exact methods remain computationally expensive and may encounter software licensing limitations (e.g., variable/constraint limits in community editions of commercial solvers).
...
Tabu Search \cite{glover1997} is an advanced metaheuristic that uses adaptive memory to guide the search beyond local optima. Unlike basic local search, Tabu Search can accept worsening moves and employs strategic mechanisms to balance intensification and diversification.
...
\begin{itemize}
  ...
  \item \textbf{Intensification}: Periodic focused search around best solutions
