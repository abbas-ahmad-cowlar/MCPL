...
\hypersetup{
  ...
  citecolor=blue,
  urlcolor=blue,
  pdftitle={MCLP Computational Study - Scientific Report},
...
\title{
  ...
  \vspace{0.5cm}
  \large Scientific Report and Computational Analysis
}
...
mosel exec mclp_local_search.mos "DATA_FILE=data/XXL1.dat INIT_METHOD=random"
\end{lstlisting}
...
parameters
  DATA_FILE = "data/instance.dat"
  NUM_STARTS = 10                  ! Number of random restarts
  VERBOSE = false                  ! Detailed output per restart
end-parameters
\end{lstlisting}
...
\begin{itemize}
  ...
  \item Intensification and diversification strategies
...
parameters
  ...
  DIVERSIFY_LIMIT = 100            ! Diversification trigger
end-parameters
\end{lstlisting}
